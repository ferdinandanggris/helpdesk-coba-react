...
const CreateUser = () => {
    ...
    const createUser = async (e)=>{
        ...
        await axios.post(`http://127.0.0.1:8000/api/users/store`,formData)
            .then(({data})=>{
                Swal.fire({
                    icon : "success",
                    text : data.message
                ...
                <Form onSubmit={createUser}>  
                    <div className={"card-body"}>
                        ...
                        <Form.Group className={"form-group"}>
                            ...
                            <Form.Control type="password" placeholder="Password" value={password} name="password" onChange={(event)=>setPassword(event.target.value)} required></Form.Control>
                        </Form.Group>
